"""
Udacity python Project (Explore US Bikeshare Data)
By: Duaa Al Abbas
"""
...
def get_filters():
    ...
    """
    print('Hello You There ! Let\'s explore some US bikeshare data!')
    # get user input for city (chicago, new york city, washington). HINT: Use a while loop to handle invalid inputs
    while True:
        city=str(input('Select a city from Chicago, New York City and Washington(E.g. Enter either chicago, new york city, washington). \n')).lower()
    ...
    while True:
        month=str(input('Do you want to filter by month? If yes, then type out the month.(E.g. Enter either january, february, ... , june) If not, type in all\n')).title()
    ...
    while True:
        day=str(input('Do you want to filter by day? If yes, then type out the day (E.g. Enter either monday, tuesday, ... sunday) If not, type in all\n')).title()
        if day not in days:
...
def time_stats(df):
    ...
    print('The most common month from the given fitered data is: {}'.format(months[month_mode-1]))
    
    # display the most common day of week
    print('The most common day from the given fitered data is: {}'.format(df['day_of_week'].mode()[0]))
    
    # display the most common start hour
    print('The most common start hour from the given fitered data is: {}'.format(df['hour'].mode()[0]))
...
def station_stats(df):
    ...
    print('The most common start station from the given fitered data is: {}'.format(df['Start Station'].mode()[0]))
    
    # display most commonly used end station
    print('The most common end station from the given fitered data is: {}'.format(df['End Station'].mode()[0]))
    
    # display most frequent combination of start station and end station trip
    most_common_combination = df['Start Station'].map(str) + ' to ' + df['End Station']
    print('The most frequent combination of start station and end station trip is: {}'.format(most_common_combination.mode()[0]))
